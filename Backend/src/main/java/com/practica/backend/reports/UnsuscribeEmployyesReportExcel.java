...
public class UnsuscribeEmployyesReportExcel {
    ...
    private void createHeaders(){
        ...
        tituloCell.setCellValue("Empleados de baja");
    ...
    private void writeDataOnTable(){
        ...
        for(Empleado empleado : empleadoList){
            ...
            celda = fila.createCell(8);
            celda.setCellValue(dateFormater(empleado.getFechaBaja()));
            celda.setCellStyle(estilo);
    ...
    public UnsuscribeEmployyesReportExcel(List<Empleado> empleadoList) {
        this.empleadoList = empleadoList;
        libro = new XSSFWorkbook();
        hoja = libro.createSheet("Empleados de baja");
    }
}
